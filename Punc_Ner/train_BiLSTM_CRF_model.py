...
save_path = "dataset/Encoded_crf_punc_data"
# embedding path
Word2vec_path = "embeddings"

char_lowercase = True
# dataset for train, validate and test
vocab = "dataset/Encoded_crf_punc_data/vocab.json"
train_set = "dataset/Encoded_crf_punc_data/train.json"
dev_set = "dataset/Encoded_crf_punc_data/dev.json"
test_set = "dataset/Encoded_crf_punc_data/test.json"
word_embedding = "dataset/Encoded_crf_punc_data/word_emb.npz"
# network parameters
num_units = 300
emb_dim = 300
char_emb_dim = 52
...
checkpoint_path = "checkpoint_BiLSTM_punc_CRF/"
summary_path = "checkpoint_BiLSTM_punc_CRF/summary/"
