from preprocessing_punc import process_data
from model_without_focal_loss_punc import BiLSTM_model, batchnize_dataset, BiLSTM_CRF_model,BiLSTM_Attention_model
# dataset path
raw_path = 'dataset/Ner_punc_data'
save_path = "dataset/Encoded_punc_data"
# embedding path
Word2vec_path = "embeddings"

char_lowercase = True
# dataset for train, validate and test
vocab = "dataset/Encoded_punc_data/vocab.json"
train_set = "dataset/Encoded_punc_data/train.json"
dev_set = "dataset/Encoded_punc_data/dev.json"
test_set = "dataset/Encoded_punc_data/test.json"
word_embedding = "dataset/Encoded_punc_data/word_emb.npz"
# network parameters
num_units = 300
emb_dim = 300
char_emb_dim = 52
...
checkpoint_path = "checkpoint_BiLSTM_CRF_punc/"
summary_path = "checkpoint_BiLSTM_CRF_punc/summary/"
model_name = "ner_punctuation_model"
...
#        print("Build models...")
#        model = BiLSTM_CRF_model(config, a, g)
