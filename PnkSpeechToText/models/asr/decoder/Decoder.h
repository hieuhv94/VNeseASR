...
class DecoderFactory {
 public:
  ...
  Decoder createDecoder(const fl::lib::text::LexiconDecoderOptions& options) const;
  Decoder createDecoder(const fl::lib::text::LexiconFreeDecoderOptions& options) const;
